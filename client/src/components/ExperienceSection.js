  ...
  const experiences = [
    {
      ...
      period: 'Feb 2024 - Dec 2024 (Intern) Apr 2025 - Presnet (SWE1)',
      description: [
        '⦿ Completing on-base installations of USAF aircraft simulations that help train pilots for first flights.',
        '⦿ Troubleshooting bugs and real time errors present in on-base installations including networking errors.',
        '⦿ Developed a tool to manage pipeline CI/CD testing, allowing for clients to easily test our installations.',
        '⦿ Crafted a plan that automatically containerised software projects with the use of large language models.',
